...
namespace ProjectAspNet.Infrastructure.DataEntity
{
    public class SaveRecipe : ISaveRecipe, IFilterRecipe, IGetRecipeById, IDeleteRecipeById, IUpdateRecipe, IGetDashboardRecipe
    {
        ...
        {
            var recipe = await _dbContext.Recipes.FirstOrDefaultAsync(d => d.Id == id);
        ...
        private Microsoft.EntityFrameworkCore.Query.IIncludableQueryable<Recipe, IList<DishTypeEntitie>> GetRecipe()
        {
            return _dbContext
                .Recipes
